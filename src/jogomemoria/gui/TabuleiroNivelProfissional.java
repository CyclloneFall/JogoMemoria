...
public class TabuleiroNivelProfissional extends javax.swing.JPanel {
    ...
    private int qtdeSelecionadas = 0;
    ...
    private void tentarJogada(int linha, int coluna, JLabel lbl) {
        ...
        lbl.setIcon(img);
        if (qtdeSelecionadas == 0) {
            ptSel1 = pt[linha][coluna];
            qtdeSelecionadas++;
        } else if (qtdeSelecionadas == 1) {
            ptSel2 = pt[linha][coluna];
            qtdeSelecionadas++;
        } else if (qtdeSelecionadas == 2) {
